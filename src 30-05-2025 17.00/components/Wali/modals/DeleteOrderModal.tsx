// E:\kp\New folder\src\components\Wali\components\modals\DeleteOrderModal.tsx
interface DeleteOrderModalProps {
    onConfirm: () => Promise<void>;
    onCancel: () => void;
  }
  
  export default function DeleteOrderModal({ onConfirm, onCancel }: DeleteOrderModalProps) {
    return (
