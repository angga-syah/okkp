// src/components/Wali/wali.tsx - ENHANCED VERSION
"use client";
...
const AdminDashboard: React.FC = () => {
  ...
  // Filter state - Change to support both single and multi-select
  ...
  useEffect(() => {
    ...
    const debounceTimer = setTimeout(() => {
      ...
      if (typeof window !== 'undefined') {
        ...
        const updateUrlParam = (name: string, value: string | number | null): void => {
  ...
  // Prepare parameters for optimized hook with correct format
