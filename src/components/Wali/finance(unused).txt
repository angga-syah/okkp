// src/components/Wali/finance.tsx - FIXED VERSION
"use client"
...
const FinanceOrderCard = ({ order, index, startIndex }: { order: Order, index: number, startIndex: number }) => {
...
export default function FinanceDashboard() {
  ...
  // Filter state - FIXED: Keep as arrays for multi-select
  ...
  // FIXED: Handle filter state persistence with debounce
  useEffect(() => {
  ...
  // FIXED: Prepare parameters for optimized hook with correct date handling
  ...
  // Logout handler - FIXED: Keep filter preferences
  ...
  // FIXED: Multi-select filter handlers
