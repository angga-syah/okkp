...
export const metadata: Metadata = {
  title: "Error Page | PT. Fortuna Sada Nioga",
  description: "Pengurusan Visa Tinggal dan Kerja Tenaga Kerja Asing",
  // other metadata
};
...
const ErrorPage = ({ errorType = "404" }: ErrorPageProps) => {
  const errorTitle = errorType === "404" 
    ? "Sorry, the page can't be found" 
    : "Server Error";
  
  const errorDescription = errorType === "404"
    ? "The page you were looking for appears to have been moved, deleted or does not exist."
    : "We're experiencing some problems on our servers. Please try again later.";
