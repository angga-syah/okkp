// src/components/Wali/components/ResultFileUploader.tsx - FIXED VERSION
  ...
  const handleUpload = async (sendEmail: boolean) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        // 🔧 FIX: Force a page refresh or state update to ensure UI reflects changes
            ...
            <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-3">
              <div className="flex items-center">
                ...
                <span className="text-xs text-green-700 dark:text-green-400">
                  File berhasil diunggah! Halaman akan diperbarui sebentar lagi...
                </span>
              </div>
            </div>
          )}
